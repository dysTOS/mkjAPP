              ...
              children: [
                {
                  ...
                  canActivate: [RouteGuard],
                  data: {
                    permissions: [PermissionKey.GRUPPEN_READ],
                  },
                },
                {
                  path: 'gruppen/:id',
            ...
            },
            {
              ...
              children: [
                ...
                },
                {
                  ...
                  canActivate: [RouteGuard],
                  data: {
                    permissions: [PermissionKey.NOTENMAPPE_READ],
                  },
                },
                {
                  path: 'mappen/:id',
                ...
                },
                {
                  ...
                  canActivate: [RouteGuard],
                  data: {
                    permissions: [PermissionKey.INSTRUMENTE_READ],
                  },
                },
                {
                  path: 'instrumente/:id',
            ...
            },
            {
              ...
              children: [
                ...
                },
                {
                  ...
                  canActivate: [RouteGuard],
                  data: {
                    permissions: [PermissionKey.KASSABUCHUNG_SAVE],
                  },
                },
                {
                ...
                },
                {
                  ...
                  canActivate: [RouteGuard],
                  data: {
                    permissions: [PermissionKey.ANSCHRIFTEN_READ],
                  },
                },
                {
                  path: 'adressen/:id',
