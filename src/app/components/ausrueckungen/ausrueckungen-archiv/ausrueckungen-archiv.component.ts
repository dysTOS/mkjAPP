...
@Component({
    templateUrl: "./ausrueckungen-archiv.component.html",
    styleUrls: ["./ausrueckungen-archiv.component.scss"],
    styles: [
        `
...
export class AusrueckungenArchivComponent implements OnInit {
