...
export class UserService {
  ...
  public currentMitglied: BehaviorSubject<Mitglied> = new BehaviorSubject<Mitglied>(null);

  private currentPermissions: BehaviorSubject<Permission[]> = new BehaviorSubject<Permission[]>(null);
  private currentMitgliedGruppen: BehaviorSubject<Gruppe[]> = new BehaviorSubject<Gruppe[]>(null);
  ...
  public getCurrentUser(): Observable<User> {
    return this.currentUser.asObservable().pipe(filter((e) => e !== null));
  }
  ...
  public hasPermissionNot(permission: PermissionKey): boolean {
    return !this.currentPermissions.getValue().find((e) => e.name === permission);
  }
